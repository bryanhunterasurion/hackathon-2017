                                        ...
                                        <div className="slds-tabs_path" role="application">
                                            <ul className="slds-tabs_path__nav" role="listbox">
                                                <li className="slds-tabs_path__item slds-is-complete slds-is-complete "
                                                    role="presentation">
                                                    <a aria-selected="false" className="slds-tabs_path__link" href="javascript:void(0);"
                                                ...
                                                <li className="slds-tabs_path__item slds-is-complete" role="presentation">
                                                    <a aria-selected="false" className="slds-tabs_path__link" href="javascript:void(0);"
                                                       id="path-2" role="option" tabIndex="-1">
                                                        ...
                                                        <span className="slds-tabs_path__title">Picking Up</span>
                                                    </a>
                                                </li>
                                                <li className="slds-tabs_path__item slds-is-current" role="presentation">
                                                    <a aria-selected="true" className="slds-tabs_path__link" href="javascript:void(0);"
                                                       id="path-3" role="option" tabIndex="0">
                                                        ...
                                                        <span className="slds-tabs_path__title">Delivering</span>
                                                    </a>
                                                </li>
                                                <li className="slds-tabs_path__item slds-is-incomplete" role="presentation">
                                                    <a aria-selected="false" className="slds-tabs_path__link" href="javascript:void(0);"
